...
print(var2 + var3)
print(var1 + var4)
print("this is typecast of string to int ", int(var6) + int(var7))
print(5 * "print line multiple time add * times \n")
print("if you want to print any operation to multiple time then rype cast in string")
print(5 * str(int(var6) + int(var7)))
